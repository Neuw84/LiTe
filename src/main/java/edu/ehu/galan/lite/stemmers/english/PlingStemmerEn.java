package edu.ehu.galan.lite.stemmers.english;
 ...
 * HREF=http://wordnet.princeton.edu/>WordNet</A>.<P>
 * It requires the class FinalSet from the <A
 * HREF=http://www.mpii.mpg.de/~suchanek/downloads/javatools> Java Tools</A>.
 * 
 * Corrected some cases with passing 's' characters by Angel Conde Manjon 
 * neuw84 at gmail dot com 2014
 */

public class PlingStemmerEn implements IStemmer {
     ...
     * their plural forms
     */
    public Set<String> categoryON_A = new FinalSet<>(
            "aphelia",
            "asyndeta",
            "automata",
            "criteria",
     ...
     * their plural forms
     */
    public Set<String> categoryO_I = new FinalSet<>(
            "alti",
            "bassi",
            "canti",
            "contralti",
     ...
     * their plural forms
     */
    public Set<String> categoryUS_I = new FinalSet<>(
            "alumni",
            "bacilli",
            "cacti",
            "foci",
     ...
     * their plural forms
     */
    public Set<String> categoryIX_ICES = new FinalSet<>(
            "appendices",
            "cervices");
    /**
     ...
     * plural forms
     */
    public Set<String> categoryIS_ES = new FinalSet<>(
     ...
     * plural forms
     */
    public Set<String> categoryOE_OES = new FinalSet<>(
            "aloes",
            "backhoes",
            "beroes",
            "canoes",
     ...
     * their plural forms
     */
    public Set<String> categoryEX_ICES = new FinalSet<>(
            "apices",
            "codices",
            "cortices",
            "indices",
     ...
     * plural forms
     */
    public Set<String> categoryU_US = new FinalSet<>(
            "apercus",
            "barbus",
            "cornus",
            "ecrus",
...
//        PlingStemmerEn stemmer = new PlingStemmerEn();
//        while (true) {
