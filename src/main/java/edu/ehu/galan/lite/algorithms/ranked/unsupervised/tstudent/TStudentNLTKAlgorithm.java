package edu.ehu.galan.lite.algorithms.ranked.unsupervised.tstudent;

/*
 *    TStudentNLTKAlgorithm.java
...
/**
 * Class that processes the LikeHoodRatio algorithm using the NLTK python toolkit
 *
 * @author Angel Conde Manjon
 */
public class TStudentNLTKAlgorithm extends AbstractAlgorithm {

    private final String BRIGRAM = "bigram_student_t";
    private final String TRIGRAM = "trigram_student_t";
    ...
    public void runAlgorithm() {
        ...
        try {
            ...
            logger.warn(TStudentNLTKAlgorithm.class.getName(), "Error while running the algorithm check dirs and NLTK installation", ex);
        }
...
//        TStudentNLTKAlgorithm alg = new TStudentNLTKAlgorithm(3);
//        alg.init(c.getDocQueue().getFirst(), System.getProperty("user.dir") + "/resources/lite/");
//        alg.runAlgorithm();
//
//    }
}
