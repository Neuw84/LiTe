package edu.ehu.galan.lite.algorithms.ranked.unsupervised.likehoodratio;

/*
 *    LikehoodRatioNLTKAlgorithm.java
...
/**
 * Class that processes the LikeHoodRatio algorithm using the NLTK python
 * toolkit
 *
 * @author Angel Conde Manjon
 */
public class LikehoodRatioNLTKAlgorithm extends AbstractAlgorithm {

    private final String BRIGRAM = "bigram_likelihood_ratio";
    private final String TRIGRAM = "trigram_likelihood_ratio";
    ...
    public void init(Document pDoc, String pPropsDir) {
        ...
        try {
            ...
            logger.error(LikehoodRatioNLTKAlgorithm.class.getName(), "Error loading properties file located in: resources/config/general.conf", ex);
        }
    }
    ...
    public void runAlgorithm() {
        ...
        try {
            ...
            logger.warn(LikehoodRatioNLTKAlgorithm.class.getName(), "Error while running the algorithm, check your bin dirs and NLTK", ex);
        }
...
//        LikehoodRatioNLTKAlgorithm alg = new LikehoodRatioNLTKAlgorithm(3);
