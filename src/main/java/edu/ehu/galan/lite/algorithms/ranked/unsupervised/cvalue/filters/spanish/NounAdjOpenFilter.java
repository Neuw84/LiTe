package edu.ehu.galan.lite.algorithms.ranked.unsupervised.cvalue.filters.spanish;
/*
 ...
 * ((<Noun><Preposition>|<Noun>)(<Adjetive>)?(<Noun>)?(<<Adjetive>>)?)+ using POS tags of Freeling
 * (EAGLES spanish tagset) more relaxed version of the other filter
 *
